...
shared_ptr<OpenGLShaderProgramContainer> OpenGLShadersRepository::getShaderProgramContainer(const string &name) const {
...
shared_ptr<OpenGLShaderProgramContainer> OpenGLShadersRepository::createShaderProgram(
    const string &name,
    ...
    auto shaderProgramContainer = make_shared<OpenGLShaderProgramContainer>(m_openGLErrorDetector, shaderProgram);
